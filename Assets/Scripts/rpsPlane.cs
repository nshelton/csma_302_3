...
public class rpsPlane : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            _currentColor = new Vector4(1, 0, 0, 1); //this is red
        }

        if (Input.GetKeyDown(KeyCode.Alpha2))
        {
            _currentColor = new Vector4(0, 1, 0, 1); //this is green
        }

        if (Input.GetKeyDown(KeyCode.Alpha3))
        {
            _currentColor = new Vector4(0, 0, 1, 1); //this is blue
        }
